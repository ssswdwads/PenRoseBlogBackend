...
public class AiProperties {
    ...
    public void postConstructLog() {
        ...
        System.out.println("[AiProperties] raw apiBaseUrl=" + apiBaseUrl + ", normalizedApiBaseUrl="
                + getNormalizedApiBaseUrl() + ", model=" + model + ", apiKeyPresent=" + (getEffectiveApiKey() != null));
    }
}
